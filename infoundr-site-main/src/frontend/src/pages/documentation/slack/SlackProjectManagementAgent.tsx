...
const SlackProjectManagementAgent: React.FC = () => {
  return (
    <div id="slack-project-management-agent" className="mb-12">
      <div className="bg-white rounded-3xl shadow-lg p-8">
        <div className="flex items-start gap-6 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-600 text-lg">Create and manage projects, tasks, and workflows directly from Slack</p>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <p className="text-gray-500 text-xs mt-1">When you want to set a deadline</p>
              </div>
              <div className="bg-gray-50 p-4 rounded-lg">
                <p className="text-gray-700 text-sm">"create a task for community day poster design assigned to Joseph"</p>
        ...
        <div className="mb-6">
          <img
            src="/images/documentation/slack/03-asana.png"
            alt="Slack Project Management Agent Example"
...
export default SlackProjectManagementAgent;
